...
export const metadata = {
  title: "Terms and Conditions | BoostMySkills",
};
          ...
          <div className="bms-legal-body">
            <section>
              ...
              <p className="bms-legal-paragraph">
                ...
                limited to online training courses, tutorials, and educational
                materials. By accessing or using our Website, you agree to be
            ...
            <section>
              ...
              <p className="bms-legal-paragraph">
                ...
                access to the Website, the server on which the Website is
                stored, or any server, computer, or database connected to the
                Website. Harms or attempts to harm minors in any way.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="bms-legal-paragraph">
                ...
                BoostMySkills&apos; content suppliers and is protected by
                international copyright laws. The compilation of all content on
                this Website is the exclusive property of BoostMySkills
                contributors and protected by international copyright laws. You
                may not copy, reproduce, republish, upload, post, transmit, or
                distribute any content from the Website in any way without our
                prior written permission. You are granted a limited,
            ...
            <section>
              ...
              <p className="bms-legal-paragraph">
                ...
                use. This license is subject to these Terms and Conditions and
                the course-specific terms that may be presented at the time of
                purchase. Courses are delivered through online streaming and are
                not downloadable unless explicitly stated. Access to courses may
                be time-limited, and access may be revoked if these Terms and
            ...
            <section>
              ...
              <p className="bms-legal-paragraph">
                ...
                Your content is not defamatory, libelous, obscene, hateful, or
                otherwise unlawful.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="bms-legal-paragraph">
                ...
                particular purpose. We do not warrant that the Website, content,
                or services will meet your requirements. In no event shall we be
            ...
            <section>
              ...
              <p className="bms-legal-paragraph">
                ...
                the Website; Your violation of any term of these Terms and
                Conditions; Your violation of any third-party right, including
                without limitation any intellectual property, privacy, or other
            ...
            <section>
              ...
              <p className="bms-legal-paragraph">
                ...
                jurisdiction of the courts located within Ireland, for the
