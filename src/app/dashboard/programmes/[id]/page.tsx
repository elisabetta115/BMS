        ...
        <main id="main">
          <div className="mx-auto max-w-3xl px-6 py-12 lg:px-8">
            ...
            <div className="rounded-2xl border border-brand-line bg-white overflow-hidden">
              <div className="h-48 bg-gradient-to-br from-[var(--bms-green)] to-[#079845] flex items-center justify-center">
                {programme.hasImage ? (
              ...
              <div className="p-8">
                <p className="text-sm text-brand-muted mb-2">{programme.code} | {programme.project}</p>
                <h1 className="text-3xl font-bold mb-4" style={{ color: "var(--bms-dark)" }}>{programme.title}</h1>
                {programme.description && <p className="text-brand-muted mb-6">{programme.description}</p>}
                <p className="text-sm text-brand-muted mb-6">This programme includes <strong>{programme.credentials.length}</strong> micro-credentials.</p>
              ...
              <div className={`border-2 rounded-2xl p-8 text-center ${hasPassed ? "border-brand-green bg-brand-pale" : "border-brand-pale"}`}>
                ...
                <div className="relative flex justify-center">
                  <svg width={ringSize} height={ringSize} className="-rotate-90">
                    <circle cx={ringSize / 2} cy={ringSize / 2} r={ringRadius} fill="none" stroke="#eaf3e7" strokeWidth={ringStroke} />
                    <circle
                      cx={ringSize / 2} cy={ringSize / 2} r={ringRadius}
                      fill="none" stroke="#079845" strokeWidth={ringStroke}
